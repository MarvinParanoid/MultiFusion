...
**
** Created: Wed 4. Mar 20:50:25 2015
...
static const char qt_meta_stringdata_AlignAndDistribute[] = {
    "AlignAndDistribute\0"
};

const QMetaObject AlignAndDistribute::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_AlignAndDistribute,
      qt_meta_data_AlignAndDistribute, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &AlignAndDistribute::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_AlignAndDistribute))
        return static_cast<void*>(const_cast< AlignAndDistribute*>(this));
    if (!strcmp(_clname, "AlignAndDistributeInterface"))
        return static_cast< AlignAndDistributeInterface*>(const_cast< AlignAndDistribute*>(this));
    if (!strcmp(_clname, "InterfacePlugin"))
        return static_cast< InterfacePlugin*>(const_cast< AlignAndDistribute*>(this));
    if (!strcmp(_clname, "com.alxn1.MultiFusion.AlignAndDistributeInterface/1.0"))
        return static_cast< AlignAndDistributeInterface*>(const_cast< AlignAndDistribute*>(this));
